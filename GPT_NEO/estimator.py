...
from gluonts.torch.model.predictor import PyTorchPredictor
from gluon.network import TradeBotPredictionNetwork, TradeBotTrainingNetwork
...
class TradeBotLightEstimator(PyTorchLightningEstimator):
    """
    The compatibility layer between TradeBot and GluonTS / PyTorchLightning.
    """
    ...
    def __init__(
        ...
        """
        A PytorchLightning/GluonTS wrapper for TradeBot
    ...
    def create_training_network(self, device: torch.device) -> nn.Module:
        """
        Create the encapsulated TradeBot model which can be used for training.
        ...
        """
        return TradeBotTrainingNetwork(
    ...
    def create_predictor(
        ...
        """
        prediction_network = TradeBotPredictionNetwork(
            num_series=self.num_series,
            model_parameters=self.model_parameters,
