...
from .network import TradeBotPredictionNetwork, TradeBotTrainingNetwork
...
class TradeBotEstimator(PyTorchEstimator):
    """
    The compatibility layer between TradeBot and GluonTS / PyTorchTS.
    """
    ...
    def __init__(
        ...
        """
        A PytorchTS wrapper for TradeBot
